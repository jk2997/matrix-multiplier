...
HD_PWD='C:/Xilinx/p/fm3/fm3.runs/design_1_axi_dotprod_4_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_dotprod_4_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_dotprod_4_0_0.tcl
